...
export function ResearchDetailsSheet({
  research,
  onApply,
  disabled,
}: ResearchDetailsSheetProps) {
      ...
      <SheetHeader className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            <Badge
              variant={getScholarshipBadgeVariant(research.scholarship_type)}
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="font-medium">
                  {research.vacancies} vaga{research.vacancies > 1 ? "s" : ""}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="font-medium text-green-600 text-lg">
                  {formatCurrency(research.monthly_value)}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2">
